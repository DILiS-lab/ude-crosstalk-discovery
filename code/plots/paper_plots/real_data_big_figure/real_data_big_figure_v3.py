...
# Legend on top-right trajectory panel
handles, labels = ax_col2[0][0].get_legend_handles_labels()
ax_col2[0][1].legend(handles, labels, loc="upper left", ncol=1, fontsize=5)
...
plt.tight_layout()
plt.savefig(SCRIPT_DIR / "real_data_big_figure_v3.pdf", dpi=300, bbox_inches="tight")
# plt.show()
