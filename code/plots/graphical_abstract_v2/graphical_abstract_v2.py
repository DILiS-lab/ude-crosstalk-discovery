...
plots_dir = code_root / "plots" / "graphical_abstract_v2"
...
def create_graphical_abstract():
    ...
    x_d0, x_d1 = 0.22, 0.38   # data line span
    x_u0, x_u1 = 0.48, 0.64   # UDE line span
    rows = [
        ("Cell 1",   "-"),
        ("Cell 2",   "--"),
        (r"  $\vdots$", None),
    ...
    fig.subplots_adjust(left=0.001, right=0.98, top=0.925, bottom=0.075)
    output_path = plots_dir / "graphical_abstract_structure_v2.pdf"
